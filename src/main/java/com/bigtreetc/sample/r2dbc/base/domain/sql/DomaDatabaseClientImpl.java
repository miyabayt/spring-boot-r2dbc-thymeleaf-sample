...
public class DomaDatabaseClientImpl implements DomaDatabaseClient {
  ...
  private GenericExecuteSpec getGenericExecuteSpec(String rawSql, List<SqlArgument> arguments) {
    GenericExecuteSpec executeSpec = r2dbcEntityTemplate.getDatabaseClient().sql(rawSql);
